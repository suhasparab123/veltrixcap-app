...
router.get("/healthz", (req, res) => {
    const logFile = path_1.default.join(__dirname, "../logs/output.log");
    try {
        const logLines = fs_1.default.readFileSync(logFile, "utf-8").trim().split("\n");
...
router.get("/metrics", (req, res) => {
    ...
    try {
        const lines = fs_1.default.readFileSync(logFile, "utf-8")
            .trim()
            .split("\n")
        ...
        res.send(`# HELP swap_optimizer_heartbeat_count Total number of heartbeats recorded
